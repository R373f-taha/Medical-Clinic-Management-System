...
@section('content')
    {{-- <a href="{{ route('doctor.patients.index') }}"
        style="display:inline-block; margin-top:20px; padding:10px 20px; background-color:#ff7a00; color:#fff; text-decoration:none; border-radius:6px; transition:background-color 0.3s;">
        Patients
    </a>
                ...
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-lg-6 mb-lg-0 mb-4">
                        <div class="copyright text-center text-sm text-muted text-lg-start">
                            ...
                            <a href="" class="font-weight-bold" target="">Creative Tim</a>
                            for a better web.
                        </div>
                    </div>
                    <div class="col-lg-6">
            ...
            y: {
                ...
                ticks: {
                    ...
                    callback: function(value) {
                        return value.toFixed(1); // إظهار الفواصل
                    }
                },
                grid: {
                    drawBorder: false,
