...
<body>
    ...
    <div class="min-h-screen relative flex items-center justify-center bg-cover bg-center"
        ...
        <!-- Card -->
        <div class="relative w-full max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden flex">
            ...
            <div class="flex-1 p-12 flex flex-col justify-center">
                ...
                <p class="text-gray-500 text-lg mb-8">
                    Professional medical clinic management system<br>
                    designed to simplify your daily workflow.
                </p>

                <div class="flex gap-4">
                    <a href="{{ route('login') }}"
                       class="px-8 py-3 bg-orange-500 text-white rounded-lg font-medium hover:bg-orange-600 transition">
                        Login
                    </a>

                    <a href="#"
                       class="px-8 py-3 border border-gray-300 text-gray-700 rounded-lg font-medium hover:border-orange-500 hover:text-orange-500 transition">
                        Learn More
                    </a>
                </div>
            ...
            <!-- Right Illustration -->
            <div class="hidden lg:flex w-1/3 bg-gray-50 items-center justify-center">
                <svg class="w-32 h-32 text-orange-500" fill="none" stroke="currentColor" stroke-width="1.5"
                     viewBox="0 0 24 24">
