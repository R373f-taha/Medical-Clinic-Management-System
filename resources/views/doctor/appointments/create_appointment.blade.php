        ...
        <div style="max-width:800px; margin:auto; background:#fff; border-radius:8px;
            ...
            <form action="{{ route('doctor.appointments.store') }}" method="POST">
                ...
                <div style="display:flex; gap:10px;">
                    <button type="submit" style="background-color:#ff7a00; color:#fff; padding:10px 20px;
                                    border:none; border-radius:6px; cursor:pointer;">
                        Save Appointment
                    </button>

                    <a href="{{ route('doctor.appointments.doctorAppointments') }}" style="background-color:#6c757d; color:#fff; padding:10px 20px;
